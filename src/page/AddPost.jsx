...
function AddPost() {
  ...
  return (
    <div className="max-h-fit bg-gradient-to-r from-black via-zinc-900 to-black text-green-300 font-[Poppins] px-6 py-20 relative">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        {/* LEFT: Glowing Phrase Section */}

        <div className="hidden md:flex flex-col justify-center px-6">
          <h2 className="text-4xl font-extrabold text-green-400 leading-tight mb-4">
            Every thought is a spark.
          </h2>
          <p className="text-lg text-green-500 italic">
          ...
          <div className="mt-10 text-sm text-green-700 tracking-widest uppercase">
            Chronicle your thoughts • Connect the dots • Contribute your voice
          </div>

          {/* Guidelines Section */}
          <div className="mt-10 p-4 bg-black/50 border border-green-700/30 shadow-lime-400/10 backdrop-blur-sm shadow-xl rounded-lg text-md text-green-400">
        ...
        {/* RIGHT: Form */}
        <div className="w-full h-auto bg-zinc-900 border border-green-700/30 rounded-2xl p-10 shadow-xl shadow-lime-400/10 backdrop-blur-sm">
          <h2 className="text-3xl mb-2 font-bold text-lime-400 text-center">
            Create New Chronicle
          </h2>
          <p className="text-center text-green-500  text-sm italic tracking-wide">
          ...
          <form onSubmit={handleSubmit(create)} className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row items-start justify-between mt-6 gap-4">
              <button
                type="submit"
